...
import os
import warnings
from sklearn.ensemble import BaggingRegressor  # Changed from BaggingClassifier
...
for target in target_cols:
    ...
    # Train model with robust parameters - CHANGED TO REGRESSION MODELS
    model = BaggingRegressor(  # Changed from BaggingClassifier
